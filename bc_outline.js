...
function makeOutline() {
      // Location of the doument outline
...
function createList(source, outlineList) {
      ...
      var prevLevel = 0;
      //keep a running total of the article headings
      var headNum = 0;
      // Loop through all of the child node of source article until no child nodes are left
      for (var n = source.firstChild; n !== null; n = n.nextSibling) {
            ...
            if (headLevel !== -1) {
                  ...
                  //use this code to create hypertext links to the document headings
                  ...
                  if (headLevel === prevLevel) {
                        ...
                        //append the list item to a hight list
